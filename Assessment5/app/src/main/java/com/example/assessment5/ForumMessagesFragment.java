...
//                                }
                                ...
                                Toast.makeText(getActivity(), "There was a error and response is not Succesful", Toast.LENGTH_SHORT);
                            }
                        }
                    });
    ...
    void getMessages(){
        ...
        Request request = new Request.Builder().url("https://www.theappsdr.com/api/messages/" + mForum.getThread_id())
                .addHeader("Authorization","BEARER "+  mAuth.getToken())
                .build();
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArrayMSG.length(); i++) {
                            JSONObject msgJsonObject = jsonArrayMSG.getJSONObject(i);
