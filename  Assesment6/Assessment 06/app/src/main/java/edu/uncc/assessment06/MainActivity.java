...
public class MainActivity extends AppCompatActivity implements LoginFragment.LoginListener, ProductsFragment.ProductListener,
    ...
    public void checkCart() {
        getSupportFragmentManager().beginTransaction().replace(R.id.rootView, new CartFragment()).commit();
    }
}